...
import tech.mogami.facilitator.verifier.exact.PaymentAddressVerifier;
...
@SpringBootTest
@DisplayName("Payment address verifier tests")
public class PaymentAddressVerifierTest {

    @Autowired
    private PaymentAddressVerifier paymentAddressVerifier;
    ...
    public void testAddressMismatch() {
        ...
        assertThat(paymentAddressVerifier.verify(
                ...
                .satisfies(result -> {
                    ...
                    assertThat(result.errorMessage()).isEqualTo("Authorization 'to' address does not match the payment requirements 'payTo' address");
                });
    }
